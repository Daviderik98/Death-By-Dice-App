...
class ChallengePicker{
    ...
    var chRoutines: [String] = ["Read a book both late evening and early morning",
                                ...
                                "Watch minimum one news report every day of one week",
                                "Eat your breakfast at exactly 8.00. Lunch exactly at 12.00. And dinner at exactly 19.00",
                                "Pack your bags for the next day 1 evening early",
    ...
    var chHonesty: [String] = ["Every time you curse during 24 hours, perform 10 pushups",
                               ...
                               "Create a new painting/drawing/photo",
    ...
    var chStayhealthy: [String] = ["Skip eating pizza & candy for one week",
                                   ...
                                   "Eat no sugar for a week",
                                   "Skip breakfast for one morning and only drink water instead",
                                   "Save your packed lunch for the day until after 1 hour of walking outside",
                                   "Save your dinner until after 2 hours of working out in the gym, no matter how late it may be",
    ]
    ...
    var chEcofriendly: [String] = ["Never EVER leave a bottle on the ground outside",
                                   ...
                                   "Pick up any can or bottle or expired battery you find on the ground and throw it away properly, during 48 hours",
                                   "Never fly when you travel for 4 months",
                                   "Spend 1 hour walking in the park and clean up any trash lying on the ground",
                                   "Don´t throw anything away in the garbage for 24 hours",
